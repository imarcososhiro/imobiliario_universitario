...
└── 📂 scripts  
<pre> ```├── 📄 tabulacao_de_dados.py  # Contém a função que limpa e tabula os dados coletados ``` </pre>
...
└── Python 🐍  
&nbs;&nbs;&nbs;&nbs;├── Selenium  
&nbs;&nbs;&nbs;&nbs;├── Pandas  
&nbs;&nbs;&nbs;&nbs;├── Folium (Planejado)  
&nbs;&nbs;&nbs;&nbs;├── Requests (Planejado)  
&nbs;&nbs;&nbs;&nbs;└── API Google Maps (Planejado)  
